	...
	return (
		<div className="flex justify-between p-8 ">
			<div className="flex items-center space-x-10 w-full ">
				...
				<form className="flex flex-grow min-w-[54rem] max-w-[54rem] justify-between items-center border border-gray-200 rounded-full px-5 py-2 h-[3.7rem] shadow-md hover:shadow-lg focus-within:shadow-md">
					<input
						ref={searchInputRef}
