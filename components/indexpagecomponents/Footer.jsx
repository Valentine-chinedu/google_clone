function Footer() {
	return (
		<div className='max-w-full'>
			<footer className='flex flex-col justify-center bg-gray-100 h-auto text-sm'>
				<div className=' flex items-center border-b w-full text-gray-500 pl-10 h-14'>
					<h3>Nigeria</h3>
				</div>

				<div className='flex items-center justify-between h-14 px-10 text-gray-500'>
